...
function isReactive(value) {
    return !!value["__v_is_reactive" /* ReactiveFlags.IS_REACTIVE */];
}
function isReadonly(value) {
    return !!value["__v_is_readonly" /* ReactiveFlags.IS_READONLY */];
}
        ...
        if (i > e1) {
            ...
            for (let i = s1; i <= e1; i++) {
                ...
                if (newIndex === undefined) {
                    ...
                    // 赋值序列映射 val代表老vnode index => 统一加一， val===0 => 代表新增vnode
...
function parseElement(context, ancestors) {
    ...
    // children 解析完成后，children tag 出栈
    ancestors.pop();
    // 清除结束标签
...
export { createApp, createVNode as createElementVNode, createRenderer, createTextVNode, effect, getCurrentInstance, h, inject, isProxy, isReactive, isReadonly, nextTick, provide, proxyRefs, reactive, readonly, ref, registerRuntimeCompiler, renderSlots, shallowReadonly, toDisplayString };
